...
export const metadata = {
  title: "Partner | SQ Schmidt Qualitaetssicherung",
...
export default async function PartnerPage() {
  ...
  // Sanity-Daten bevorzugen, Fallback auf statische Daten
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
              ...
              um Ihnen hoechste Qualitaet zu garantieren.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {partner.map((p: any, i: number) => (
              <div
                key={i}
                className="flex flex-col gap-3 p-6 bg-card border border-border rounded-xl hover:border-primary/50 transition-colors group"
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">{p.beschreibung ?? p.description}</p>
                </div>
                {p.webseite && (
                  <a
                    href={p.webseite}
