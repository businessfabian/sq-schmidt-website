...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: "oeffnungszeiten", title: "Öffnungszeiten", type: "string" }),
    ...
    defineField({ name: "uebermichTitel", title: "Über uns Titel", type: "string" }),
    defineField({ name: "uebermichText", title: "Über uns Text", type: "text", rows: 5 }),
    ...
    defineField({ name: "jahreErfahrung", title: "Jahre Erfahrung (Zahl)", type: "number" }),
    defineField({ name: "anzahlProjekte", title: "Anzahl Projekte (Zahl)", type: "number" }),
  ],
})
