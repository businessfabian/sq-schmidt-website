...
*/ class BlockWrapper extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeValue"] {
...
const blockWrappers = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Facet"].define();
...
class WidgetTile extends Tile {
    ...
    get overrideDOMText() {
        if (!this.length) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty;
        let { root } = this;
        if (!root) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].empty;
...
class TileUpdate {
    constructor(view, old, blockWrappers, decorations, disallowBlockEffectsFor){
        ...
        this.builder = new TileBuilder(this.cache, new DocTile(view, view.contentDOM), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].iter(blockWrappers));
    ...
    emit(from, to) {
        ...
        let openEnd = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].spans(this.decorations, from, to, {
    ...
    coordsForChar(pos) {
        ...
        function scan(tile, offset) {
            if (tile.isComposite()) {
                ...
                let end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(tile.text, offset);
...
function moveVertically(view, start, forward, distance) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(pos.pos, pos.assoc, undefined, goal);
}
...
class InlineCoordsScan {
    ...
    scanText(tile, offset) {
        let positions = [];
        for(let i = 0; i < tile.length; i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findClusterBreak"])(tile.text, i))positions.push(offset + i);
...
class DOMReader {
    constructor(points, view){
        ...
        this.view = view;
        this.text = "";
        this.lineSeparator = view.state.facet(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorState"].lineSeparator);
    }
    append(text) {
        this.text += text;
    }
...
class DOMChange {
    constructor(view, start, end, typeOver){
        ...
        if (view.state.readOnly && start > -1) {
            ...
            if (view.inputState.composing > -1 && view.state.selection.ranges.length > 1) this.newSel = view.state.selection.replaceRange(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].range(anchor, head));
            else this.newSel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].single(anchor, head);
        }
    }
}
    ...
    if (domChange.bounds) {
        ...
        if (!sel.empty && sel.from >= from && sel.to <= to && (domChange.typeOver || cmp != domChange.text) && cmp.slice(0, sel.from - from) == domChange.text.slice(0, sel.from - from) && cmp.slice(sel.to - from) == domChange.text.slice(selEnd = domChange.text.length - (cmp.length - (sel.to - from)))) {
            ...
            change = {
                from: sel.from,
                to: sel.to,
                insert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].of(domChange.text.slice(sel.from - from, selEnd).split(LineBreakPlaceholder))
            };
...
function applyDefaultInsert(view, change, newSel) {
    ...
    if (inAtomic > -1) {
        tr = {
            changes: change,
            selection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorSelection"].cursor(change.from + change.insert.length, -1)
        };
...
function staticDeco(state) {
    ...
    if (outer.length) deco.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RangeSet"].join(outer));
    return deco;
}
    ...
    constructor(view){
        ...
        this.handlers.textupdate = (e)=>{
            ...
            let change = {
                from: diff.from + from,
                to: diff.toA + from,
                insert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Text"].of(e.text.slice(diff.from, diff.toB).split("\n"))
            };
...
*/ class EditorView {
    ...
    */ constructor(config = {}){
        ...
        */ this.measureRequests = [];
        ...
        this.viewState = new ViewState(this, config.state || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EditorState"].create(config));
...
function runHandlers(map, event, view, scope) {
    ...
    if (scopeObj) {
        ...
        !(browser.mac && event.altKey && !(event.ctrlKey || event.metaKey)) && (baseName = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$w3c$2d$keyname$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["base"][event.keyCode]) && baseName != name) {
...
*/ function showDialog(view, config) {
    ...
    if (view.state.field(dialogField, false)) {
        ...
        view.dispatch({
            effects: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].appendConfig.of(dialogField.init(()=>[
                    panelCtor
                ]))
        });
    }
...
const openDialogEffect = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define();
const closeDialogEffect = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StateEffect"].define();
function createDialog(view, config, result) {
    let content = config.content ? config.content(view, ()=>done(null)) : null;
    if (!content) {
        content = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crelt$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])("form");
        if (config.input) {
            let input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crelt$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])("input", config.input);
            if (/^(text|password|number|email|tel|url)$/.test(input.type)) input.classList.add("cm-textfield");
            if (!input.name) input.name = "input";
            content.appendChild((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crelt$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])("label", (config.label || "") + ": ", input));
        } else {
            content.appendChild(document.createTextNode(config.label || ""));
        }
        content.appendChild(document.createTextNode(" "));
        content.appendChild((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crelt$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])("button", {
            class: "cm-button",
            type: "submit"
    ...
    let panel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crelt$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])("div", content, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crelt$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])("button", {
        onclick: ()=>done(null),
...
//# sourceMappingURL=node_modules_%40codemirror_view_dist_index_2a0db5c6.js.map