$base = "C:\Users\fabia\sq-schmidt-website"
$enc = [System.Text.UTF8Encoding]::new($false)

# API Route für Resend
New-Item -ItemType Directory -Force -Path "$base\app\api\kontakt" | Out-Null
[System.IO.File]::WriteAllText("$base\app\api\kontakt\route.ts", @'
...
# Kontaktformular mit echtem Submit
[System.IO.File]::WriteAllText("$base\components\contact-form.tsx", @'
"use client"
...
# Resend installieren
Set-Location $base
npm install resend 2>&1 | Select-String "added|error"

git -C $base add .
git -C $base commit -m "feat: kontaktformular mit resend api"
git -C $base push
