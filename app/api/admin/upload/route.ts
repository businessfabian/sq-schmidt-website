...
export async function POST(req: Request) {
  ...
  const type = formData.get("type") as string // "partner" | "zertifikat" | "hero" | "leistung"
  ...
  const ALLOWED_UPLOAD_TYPES = ["partner", "zertifikat", "hero", "leistung"]
  ...
  const fieldMap: Record<string, string> = { partner: "logo", zertifikat: "bild", hero: "heroBild", leistung: "bild" }
