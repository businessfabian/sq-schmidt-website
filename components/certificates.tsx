        ...
        <ScrollReveal stagger={100}>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {list.map((cert: any, i: number) => (
              <div key={i} className="relative bg-card border border-border rounded-xl hover:border-primary/50 hover:-translate-y-1 hover:shadow-xl transition-all group overflow-hidden h-full">
                {cert.image && (
